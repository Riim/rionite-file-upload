(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["index"] = factory(require("cellx"), require("cellx-indexed-collections"), require("rionite"));
	else
		root["index"] = factory(root["cellx"], root["cellx-indexed-collections"], root["rionite"]);
...
var escapeRegExp_1 = __webpack_require__(8);
__webpack_require__(9);
var ReadableFile_1 = __webpack_require__(10);
...
var RioniteFileUpload = (function (_super) {
    ...
    RioniteFileUpload.prototype.initialize = function () {
        ...
        if (typePattern) {
            this._reFileType = RegExp("^" + escapeRegExp_1.escapeRegExp(typePattern).split('\\*').join('.*') + "$");
        }
        cellx_1.define(this, {
            errorMessage: null,
            error: false
...
module.exports = (function(d) {
        ...
        if (head) {
            ...
            style.type = 'text/css';
            style.textContent = ".rionite-file-upload{display:block;-webkit-box-sizing:border-box;box-sizing:border-box;padding:12px;min-width:400px;border:1px solid #ccc;color:#4d4d4d;font-size:1rem;line-height:1.5}.rionite-file-upload .rionite-file-upload__file-list{margin:0;padding:0;list-style:none}.rionite-file-upload .rionite-file-upload__file{position:relative;margin-bottom:10px;padding:12px 52px 12px 20px;border-radius:3px;background:#f2f2f2}.rionite-file-upload .rionite-file-upload__file-preview-wrapper{position:relative;display:inline-block;margin-right:10px;width:48px;height:48px;vertical-align:middle}.rionite-file-upload .rionite-file-upload__file-preview,.rionite-file-upload .rionite-file-upload__file-icon,.rionite-file-upload .rionite-file-upload__file-loading-icon{position:absolute;top:0;right:0;bottom:0;left:0;display:block;margin:auto}.rionite-file-upload .rionite-file-upload__file-preview{max-width:48px;max-height:48px;border:0;border-radius:3px}.rionite-file-upload .rionite-file-upload__file-icon{width:48px;height:48px;fill:currentColor}.rionite-file-upload .rionite-file-upload__file-loading-icon{width:20px;height:20px;-webkit-animation:rionite-file-upload__file-loading-icon-animation 1.2s infinite linear;animation:rionite-file-upload__file-loading-icon-animation 1.2s infinite linear;fill:currentColor}.rionite-file-upload .rionite-file-upload__file-text{vertical-align:middle;font-weight:700}.rionite-file-upload .rionite-file-upload__btn-remove-file{position:absolute;top:0;right:10px;bottom:0;display:block;margin:auto;padding:10px;width:42px;height:42px;border:0;background:0 0;color:#999;cursor:pointer;-webkit-transition:color .1s;-o-transition:color .1s;transition:color .1s;-webkit-transform:translateY(-1px);-ms-transform:translateY(-1px);transform:translateY(-1px)}.rionite-file-upload .rionite-file-upload__btn-remove-file:hover{color:#4d4d4d}.rionite-file-upload .rionite-file-upload__btn-remove-file:active{-webkit-transform:translateY(0);-ms-transform:translateY(0);transform:translateY(0)}.rionite-file-upload .rionite-file-upload__btn-remove-file-icon{display:block;width:22px;height:22px;fill:currentColor}.rionite-file-upload .rionite-file-upload__files-input{display:none}.rionite-file-upload .rionite-file-upload__drop-zone{position:relative;padding:25px;border:2px dashed #999;border-radius:5px;background:#f2f2f2;color:gray;text-align:center;cursor:pointer}.rionite-file-upload .rionite-file-upload__drop-zone[over]{border-color:#168cf3}.rionite-file-upload .rionite-file-upload__drop-zone[over] .rionite-file-upload__drop-zone-text{pointer-events:none}.rionite-file-upload .rionite-file-upload__drop-zone[error] .rionite-file-upload__drop-zone-error-message-wrapper{display:block}.rionite-file-upload .rionite-file-upload__drop-zone-error-message-wrapper{position:absolute;top:0;right:0;bottom:0;left:0;display:none;border-radius:inherit;background:inherit;white-space:nowrap;font-size:0}.rionite-file-upload .rionite-file-upload__drop-zone-error-message-wrapper::after{display:inline-block;width:0;height:100%;content:'';vertical-align:middle}.rionite-file-upload .rionite-file-upload__drop-zone-error-message{color:red;vertical-align:middle;font-size:1rem}.rionite-file-upload .rionite-file-upload__btn-select-files{display:inline;padding:0;border:0;background:0 0;color:#168cf3;font:inherit;cursor:inherit}@-webkit-keyframes rionite-file-upload__file-loading-icon-animation{0%{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes rionite-file-upload__file-loading-icon-animation{0%{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}";
