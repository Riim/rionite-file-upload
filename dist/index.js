...
(function _() { if (document.body) { document.body.insertAdjacentHTML('beforeend', "<svg xmlns=\"http://www.w3.org/2000/svg\" style=\"display:none\"><symbol viewBox=\"0 0 32 32\" id=\"RioniteFileUpload__iconFile\"><path d=\"M28.681 7.159c-.694-.947-1.662-2.053-2.724-3.116s-2.169-2.03-3.116-2.724C21.229.137 20.448 0 20 0H4.5A2.503 2.503 0 0 0 2 2.5v27C2 30.878 3.122 32 4.5 32h23c1.378 0 2.5-1.122 2.5-2.5V10c0-.448-.137-1.23-1.319-2.841zm-4.138-1.702A27.334 27.334 0 0 1 26.811 8H22V3.189a27.334 27.334 0 0 1 2.543 2.268zM28 29.5c0 .271-.229.5-.5.5h-23a.507.507 0 0 1-.5-.5v-27c0-.271.229-.5.5-.5H20v7a1 1 0 0 0 1 1h7v19.5z\" xmlns=\"http://www.w3.org/2000/svg\"/></symbol></svg>"); } else { setTimeout(_, 100); } })();

/***/ }),
/* 9 */
/***/ (function(module, exports) {

(function _() { if (document.body) { document.body.insertAdjacentHTML('beforeend', "<svg xmlns=\"http://www.w3.org/2000/svg\" style=\"display:none\"><symbol viewBox=\"0 0 32 32\" id=\"RioniteFileUpload__iconSpinner\"><path d=\"M16 32c-4.274 0-8.292-1.664-11.314-4.686S0 20.274 0 16c0-3.026.849-5.973 2.456-8.522a16.061 16.061 0 0 1 6.386-5.791l1.344 2.682a13.044 13.044 0 0 0-5.192 4.708A12.953 12.953 0 0 0 3 15.999c0 7.168 5.832 13 13 13s13-5.832 13-13c0-2.459-.69-4.853-1.994-6.922a13.051 13.051 0 0 0-5.192-4.708l1.344-2.682a16.047 16.047 0 0 1 6.386 5.791A15.953 15.953 0 0 1 32 16c0 4.274-1.664 8.292-4.686 11.314S20.274 32 16 32z\" xmlns=\"http://www.w3.org/2000/svg\"/></symbol></svg>"); } else { setTimeout(_, 100); } })();

/***/ }),
/* 10 */
/***/ (function(module, exports) {

(function _() { if (document.body) { document.body.insertAdjacentHTML('beforeend', "<svg xmlns=\"http://www.w3.org/2000/svg\" style=\"display:none\"><symbol viewBox=\"0 0 32 32\" id=\"RioniteFileUpload__iconTrash\"><path d=\"M4 10v20c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V10H4zm6 18H8V14h2v14zm4 0h-2V14h2v14zm4 0h-2V14h2v14zm4 0h-2V14h2v14z\" xmlns=\"http://www.w3.org/2000/svg\"/><path d=\"M26.5 4H20V1.5c0-.825-.675-1.5-1.5-1.5h-7c-.825 0-1.5.675-1.5 1.5V4H3.5C2.675 4 2 4.675 2 5.5V8h26V5.5c0-.825-.675-1.5-1.5-1.5zM18 4h-6V2.025h6V4z\"/></symbol></svg>"); } else { setTimeout(_, 100); } })();
...
module.exports = (function(d) {
        ...
        if (head) {
            ...
            style.type = 'text/css';
            style.textContent = ".RioniteFileUpload{display:block;-webkit-box-sizing:border-box;box-sizing:border-box;padding:12px;min-width:400px;border:1px solid #ccc;color:#4d4d4d;font-size:1rem;line-height:1.5}.RioniteFileUpload .RioniteFileUpload__file-list{margin:0;padding:0;list-style:none}.RioniteFileUpload .RioniteFileUpload__file{position:relative;margin-bottom:10px;padding:12px 52px 12px 20px;border-radius:3px;background:#f2f2f2}.RioniteFileUpload .RioniteFileUpload__file-preview-wrapper{position:relative;display:inline-block;margin-right:10px;width:48px;height:48px;vertical-align:middle}.RioniteFileUpload .RioniteFileUpload__file-preview,.RioniteFileUpload .RioniteFileUpload__file-icon,.RioniteFileUpload .RioniteFileUpload__file-loading-icon{position:absolute;top:0;right:0;bottom:0;left:0;display:block;margin:auto}.RioniteFileUpload .RioniteFileUpload__file-preview{max-width:48px;max-height:48px;border:0;border-radius:3px}.RioniteFileUpload .RioniteFileUpload__file-icon{width:48px;height:48px;fill:currentColor}.RioniteFileUpload .RioniteFileUpload__file-loading-icon{width:20px;height:20px;-webkit-animation:RioniteFileUpload__file-loading-icon-animation 1.2s infinite linear;animation:RioniteFileUpload__file-loading-icon-animation 1.2s infinite linear;fill:currentColor}.RioniteFileUpload .RioniteFileUpload__file-text{vertical-align:middle;font-weight:700}.RioniteFileUpload .RioniteFileUpload__btn-remove-file{position:absolute;top:0;right:10px;bottom:0;display:block;margin:auto;padding:10px;width:42px;height:42px;border:0;background:0 0;color:#999;cursor:pointer;-webkit-transition:color .1s;-o-transition:color .1s;transition:color .1s;-webkit-transform:translateY(-1px);-ms-transform:translateY(-1px);transform:translateY(-1px)}.RioniteFileUpload .RioniteFileUpload__btn-remove-file:hover{color:#4d4d4d}.RioniteFileUpload .RioniteFileUpload__btn-remove-file:active{-webkit-transform:translateY(0);-ms-transform:translateY(0);transform:translateY(0)}.RioniteFileUpload .RioniteFileUpload__btn-remove-file-icon{display:block;width:22px;height:22px;fill:currentColor}.RioniteFileUpload .RioniteFileUpload__drop-zone{position:relative;padding:25px;border:2px dashed #999;border-radius:5px;background:#f2f2f2;color:gray;text-align:center;cursor:pointer}.RioniteFileUpload .RioniteFileUpload__drop-zone[over]{border-color:#168cf3}.RioniteFileUpload .RioniteFileUpload__drop-zone[over] .RioniteFileUpload__drop-zone-text{pointer-events:none}.RioniteFileUpload .RioniteFileUpload__drop-zone[error] .RioniteFileUpload__drop-zone-error-message-wrapper{display:block}.RioniteFileUpload .RioniteFileUpload__drop-zone-error-message-wrapper{position:absolute;top:0;right:0;bottom:0;left:0;display:none;border-radius:inherit;background:inherit;white-space:nowrap;font-size:0}.RioniteFileUpload .RioniteFileUpload__drop-zone-error-message-wrapper::after{display:inline-block;width:0;height:100%;content:'';vertical-align:middle}.RioniteFileUpload .RioniteFileUpload__drop-zone-error-message{color:red;vertical-align:middle;font-size:1rem}.RioniteFileUpload .RioniteFileUpload__btn-select-files{display:inline;padding:0;border:0;background:0 0;color:#168cf3;font:inherit;cursor:inherit}.RioniteFileUpload .RioniteFileUpload__files-input{display:none}@-webkit-keyframes RioniteFileUpload__file-loading-icon-animation{0%{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes RioniteFileUpload__file-loading-icon-animation{0%{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}";
