...
var i18n = {
    ...
    typeErrorMessage: rionite_1.getText.t('Файл "{name}" не подходит по типу'),
    sizeErrorMessage: rionite_1.getText.t('Файл "{name}" слишком большой')
};
